...
<template>
  <header class="fixed w-full h-36 z-10 flex justify-center items-center">
    <img class="w-full h-full object-cover absolute top-0 left-0 right-0 z-0" src="../assets/navbar-bg.svg" alt="header bg"/>
